...
const navigationConfig = [
  ...
  //   id: "subscriptions",
  //   title: "Subscriptions",
  //   subtitle: "Subscriptions List",
  //   type: "group",
  //   icon: "heroicons-outline:home",
  //   translate: "SUBSCRIPTIONS",
  //   subtitleTranslate: "SUBSCRIPTIONS",
  //   children: [
  //     {
  ...
  // },
  {
    id: "miniapps",
    title: "MiniApps",
    subtitle: "Panel miniapps section",
    type: "group",
    icon: "heroicons-outline:cube",
    translate: "MINIAPPS",
    subtitleTranslate: "SUB_MINIAPPS",
    children: [
      {
        id: "miniapps.management",
        title: "MiniApps Management",
        type: "item",
        icon: "heroicons-outline:paper-airplane",
        url: "/miniapps/management",
        translate: "MINIAPPS_MANAGEMENT",
      },
    ],
  },
  // {
  //   id: "file-manager.access-manager",
  //   title: "Access Manager",
  //   type: "item",
  //   icon: "heroicons-outline:paper-airplane",
  //   url: "/apps/access-manager",
  //   translate: "ACCESS_MANAGER",
  // },
  {
    id: "apps",
    title: "Applications",
    ...
    children: [
      ...
      },
      {
        ...
        icon: "heroicons-outline:paper-airplane",
        url: "/apps/pdf-viewer",
        translate: "PDF_VIEWER",
        subtitleTranslate: "SUB_PDF_VIEWER",
      },
      // {
      //   id: "apps.access-manager",
      //   title: "Access Manager",
      //   type: "item",
      //   icon: "heroicons-outline:paper-airplane",
      //   url: "/apps/access-manager",
      ...
      {
        id: "apps.form-builder",
        title: "Form Builder",
        type: "item",
        icon: "heroicons-outline:paper-airplane",
        url: "/apps/form-builder",
        translate: "FORM_BUILDER",
      },
      {
        id: "apps.workflows",
        title: "Workflows",
  ...
  },
  {
    ...
    children: [
      ...
      // {
      //   id: "file-manager.image-manager",
      //   title: "Image Manager",
      //   translate: "FILE_SYSTEM_IMAGE_MANAGER",
      //   type: "item",
      //   icon: "heroicons-outline:document",
