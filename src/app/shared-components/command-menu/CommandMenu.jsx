...
import 'app/shared-components/command-menu/cmdk/raycast.css';
import { Popover, PopoverPaper } from '@mui/material';
import {
	Logo,
	LinearIcon,
	FigmaIcon,
	...
	YouTubeIcon,
	RaycastIcon
} from 'app/shared-components/command-menu/cmdk/icons';
import PopoverPopupState from '@/app/main/documentation/material-ui-components/components/popover/PopoverPopupState.jsx';

function RaycastCMDK() {
...
function Item({ children, value, keywords, isCommand = false }) {
	return (
		<Command.Item
			value={value}
			keywords={keywords}
...
// function SubCommand({ inputRef, listRef, selectedValue }) {
// 	// const [open, setOpen] = React.useState(false);
// 	const [cmdkAnchorEl, setCmdkAnchorEl] = useState(null);
// 	const cmdkInputRef = useRef(null);
//
// 	const handleOpen = (event) => {
// 		setCmdkAnchorEl(event.currentTarget);
// 	};
//
// 	const handleClose = () => {
// 		setCmdkAnchorEl(null);
// 		setTimeout(() => cmdkInputRef.current?.focus(), 0); // Restore focus
// 	};
//
// 	const open = Boolean(cmdkAnchorEl);
//
// 	React.useEffect(() => {
// 		function listener(e) {
// 			if (e.key === 'k' && e.metaKey) {
...
// 							<WindowIcon />
// 						</ListItemIcon>
// 						<ListItemText primary="Open Application" />
...
// 							<FinderIcon />
// 						</ListItemIcon>
// 						<ListItemText primary="Show in Finder" />
// 						<Typography variant="body2">⌘ ↵</Typography>
// 					</ListItem>
//
// 					<ListItem button>
...
// 							<FinderIcon />
// 						</ListItemIcon>
// 						<ListItemText primary="Show Info in Finder" />
