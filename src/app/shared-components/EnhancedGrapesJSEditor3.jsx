...
const RTLBox = styled(Box)(({ theme }) => ({
	direction: 'rtl',
	fontFamily: 'Vazirmatn, sans-serif', // Persian font
	'& .gjs-cv-canvas': {
		direction: 'ltr', // Canvas content should be LTR
	}
}));
...
const EnhancedGrapesJSEditor3 = ({ initialContent = '', onSave, templateId = null }) => {
...
export default EnhancedGrapesJSEditor3;
