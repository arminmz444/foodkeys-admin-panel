...
// // const EnhancedGrapesJSEditor = ({ companyId, onSave }) => {
...
// //       // Configure custom blocks for template variables
...
// //   const loadExistingMiniapp = async (companyId) => {
// //     try {
// //       // Fetch the miniapp associated with this company
// //       const response = await fetch(`/api/miniapps/company/${companyId}`);
// //       if (response.ok) {
// //         const data = await response.json();
// //         if (data) {
// //           // Set metadata
...
// //             navigationIcon: data.navigationIcon || "Dashboard",
// //             navigationTooltip: data.navigationTooltip || "",
// //             targetCompanyId: companyId,
// //           });
          
// //           // Load HTML content into editor
// //           if (data.content && editorInstance.current) {
// //             editorInstance.current.setComponents(data.content.html || '');
// //             editorInstance.current.setStyle(data.content.css || '');
// //             setScriptContent(data.content.js || '');
// //           }
// //         }
// //       }
// //     } catch (error) {
...
// //     setMiniappMetadata(prev => ({
// //       ...prev,
// //       [name]: value
// //     }));
// //   };
  
// //   // Handle access checkbox changes
...
// //     // Validate metadata
// //     if (!miniappMetadata.name || !miniappMetadata.routePath) {
// //       alert('نام و مسیر مینی‌اپ الزامی است');
// //       return;
// //     }
...
// //     try {
// //       // Get HTML, CSS, and JS from editor
...
// //       formData.append('metadata', JSON.stringify(miniappMetadata));
// //       formData.append('content', JSON.stringify(content));
      
// //       // API call to save or update miniapp
// //       const url = miniappMetadata.id ? `/api/miniapps/${miniappMetadata.id}` : '/api/miniapps';
// //       const method = miniappMetadata.id ? 'PUT' : 'POST';
...
// //         // Set success state and published URL
// //         setPublishSuccess(true);
// //         const baseUrl = miniappMetadata.clientType === 'ADMIN_PANEL_CLIENT' 
// //           ? '/admin' 
// //           : '/view/producers/details';
          
// //         setPublishedUrl(`${baseUrl}${miniappMetadata.routePath}`);
        
// //         // If it's a new miniapp, update ID for future saves
// //         if (!miniappMetadata.id && data.id) {
// //           setMiniappMetadata(prev => ({ ...prev, id: data.id }));
// //         }
...
// //         }
// //       } else {
// //         throw new Error('Failed to publish miniapp');
// //       }
// //     } catch (error) {
...
// //       alert(`خطا در انتشار مینی‌اپ: ${error.message}`);
// //     }
// //   };
  
// //   // Handle tab change in publish drawer
// //   const handleTabChange = (event, newValue) => {
// //     setTabValue(newValue);
// //   };
  
// //   // Handle selecting an existing miniapp for versioning
// //   const handleSelectExistingMiniapp = (event, value) => {
// //     if (value) {
// //       // Update form with selected miniapp data, but increment version
// //       const currentVersion = value.version || "1.0.0";
// //       const versionParts = currentVersion.split('.');
// //       const newVersion = `${versionParts[0]}.${versionParts[1]}.${parseInt(versionParts[2] || 0) + 1}`;
      
// //       setMiniappMetadata({
// //         ...value,
// //         id: value.id, // Keep the ID for updating
// //         version: newVersion,
// //       });
// //     }
// //   };
  
// //   // Close the publish drawer and reset publish states
...
// //         {/* Left Sidebar - Blocks */}
// //         <Box sx={{ width: '240px', backgroundColor: '#f5f5f5', overflowY: 'auto', borderLeft: '1px solid #ddd', p: 1 }}>
// //           <Typography variant="subtitle2" gutterBottom>بلوک‌ها</Typography>
...
// //             <div className="panel-devices-container"></div>
// //             <div className="panel-custom-actions-container"></div>
// //           </Box>
// //           <Box ref={editorRef} sx={{ flex: 1 }}></Box>
// //         </Box>
        
// //         {/* Right Sidebar - Styles & Layers */}
// //         <Box sx={{ width: '240px', backgroundColor: '#f5f5f5', overflowY: 'auto', borderRight: '1px solid #ddd' }}>
// //           <Tabs
// //             value={tabValue}
...
// //         </DialogContent>
// //         <DialogActions>
// //           <Button onClick={() => setIsScriptEditorOpen(false)} color="primary">
// //             لغو
// //           </Button>
// //           <Button 
// //             onClick={() => {
...
// //       {/* Publish Drawer */}
// //       <Drawer
// //         anchor="right" // RTL layout so drawer comes from right
// //         open={isPublishDrawerOpen}
// //         onClose={handleClosePublishDrawer}
// //         sx={{ '& .MuiDrawer-paper': { width: { xs: '100%', sm: '500px' } } }}
// //       >
// //         <Box sx={{ p: 3 }}>
// //           <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
// //             <Typography variant="h6">انتشار مینی‌اپ</Typography>
// //             <IconButton onClick={handleClosePublishDrawer} edge="end">
// //               <Close />
// //             </IconButton>
// //           </Box>
...
// //                 <Box>
// //                   <Autocomplete
// //                     options={existingMiniapps}
// //                     getOptionLabel={(option) => `${option.name} (${option.version})`}
// //                     onChange={handleSelectExistingMiniapp}
// //                     renderInput={(params) => (
// //                       <TextField
// //                         {...params}
// //                         label="انتخاب مینی‌اپ موجود (برای بروزرسانی)"
// //                         margin="normal"
// //                         fullWidth
// //                       />
// //                     )}
...
// //                   <FormControl fullWidth margin="normal">
// //                     <InputLabel>نوع ادغام</InputLabel>
// //                     <Select
...
// //                     margin="normal"
// //                     required
// //                     helperText="مثال: /companies/view یا /miniapps/my-app"
// //                   />
...
// //                         onChange={(e) => setMiniappMetadata(prev => ({
// //                           ...prev,
...
// //                   {miniappMetadata.showInNavigation && (
// //                     <>
// //                       <TextField
// //                         fullWidth
// //                         label="آیکون منو"
...
// //                         onChange={handleMetadataChange}
// //                         margin="normal"
// //                         helperText="نام آیکون از Material Icons"
// //                       />
                      
// //                       <TextField
// //                         fullWidth
// //                         label="متن راهنمای منو"
...
// //                   <Autocomplete
// //                     options={[]}  // This would be populated with company list
// //                     getOptionLabel={(option) => option.companyName || ''}
// //                     value={miniappMetadata.targetCompanyId ? { id: miniappMetadata.targetCompanyId } : null}
// //                     onChange={(e, value) => setMiniappMetadata(prev => ({
// //                       ...prev,
// //                       targetCompanyId: value ? value.id : null
// //                     }))}
// //                     renderInput={(params) => (
// //                       <TextField
// //                         {...params}
// //                         label="شرکت هدف (اختیاری)"
// //                         margin="normal"
// //                         fullWidth
// //                         helperText="فقط برای صفحات خاص شرکت"
// //                       />
// //                     )}
// //                   />
// //                 </Box>
...
// //                   <Paper sx={{ p: 2, maxHeight: '300px', overflowY: 'auto' }}>
...
// //                             onChange={() => handleAccessChange(role.name)}
// //                           />
// //                         }
...
// //                 <Button onClick={handleClosePublishDrawer}>
// //                   لغو
// //                 </Button>
// //                 <Button
// //                   variant="contained"
...
//         // Create field
//         createFieldButton.addEventListener('click', function() {
...
//       case 'password': return 'fa fa-asterisk';
//       case 'email': return 'fa fa-envelope';
//       case 'number': return 'fa fa-sort-numeric-asc';
//       case 'tel': return 'fa fa-phone';
//       case 'url': return 'fa fa-link';
//       case 'checkbox': return 'fa fa-check-square-o';
//       case 'radio': return 'fa fa-dot-circle-o';
//       case 'textarea': return 'fa fa-align-left';
//       case 'select': return 'fa fa-caret-down';
//       case 'range': return 'fa fa-sliders';
//       case 'date': return 'fa fa-calendar';
//       case 'time': return 'fa fa-clock-o';
//       case 'datetime': return 'fa fa-clock-o';
//       case 'datetime-local': return 'fa fa-clock-o';
//       case 'week': return 'fa fa-calendar';
//       case 'month': return 'fa fa-calendar';
...
//   const loadExistingMiniapp = async (companyId) => {
//     try {
//       // Try to find a miniapp associated with this company
//       const response = await axios.get(`/api/miniapps/company/${companyId}`);
      
//       if (response.status === 200 && response.data && response.data.length > 0) {
//         // Use the first miniapp found
//         const miniapp = response.data[0];
...
//           clientType: miniapp.clientType,
//           routePath: miniapp.routePath,
//           integrationType: miniapp.integrationType,
//           access: miniapp.access || [],
//           showInNavigation: miniapp.showInNavigation || true,
...
//         // Load HTML content into editor
//         if (miniapp.content && editorInstance.current) {
//           editorInstance.current.setComponents(miniapp.content.html || '');
//           editorInstance.current.setStyle(miniapp.content.css || '');
//           setScriptContent(miniapp.content.js || '');
//         }
//       }
//     } catch (error) {
//       console.error('Error loading miniapp:', error);
//       // No existing miniapp found, that's OK for new companies
//       if (error.response && error.response.status !== 404) {
//         alert('خطا در بارگذاری مینی‌اپ');
//       }
//     }
//   };
...
//         // Determine URL based on client type
//         const baseUrl = miniappMetadata.clientType === 'ADMIN_PANEL_CLIENT' 
//           ? '/admin' 
//           : '/view/producers/details';
          
//         // For admin panel, append the route path
//         // For public portal, use the company id parameter
//         const publicUrl = miniappMetadata.clientType === 'ADMIN_PANEL_CLIENT'
//           ? `${baseUrl}${miniappMetadata.routePath}`
//           : `${baseUrl}?id=${miniappMetadata.targetCompanyId}`;
          
//         setPublishedUrl(publicUrl);
        
//         // Update the miniappMetadata if this was a new miniapp
//         if (!miniappMetadata.id && response.data && response.data.id) {
//           setMiniappMetadata(prev => ({
//             ...prev,
//             id: response.data.id
//           }));
...
//       let errorMessage = 'خطا در انتشار مینی‌اپ';
...
//                   <TextField
//                     fullWidth
//                     label="شناسه شرکت هدف"
//                     name="targetCompanyId"
//                     value={miniappMetadata.targetCompanyId || ''}
//                     onChange={handleMetadataChange}
//                     margin="normal"
//                     type="number"
//                     helperText="فقط برای صفحات خاص شرکت"
