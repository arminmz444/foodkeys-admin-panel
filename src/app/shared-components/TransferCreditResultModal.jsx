...
export default function TransferCreditResultModal({ size = 100, strokeWidth = 2, color = "currentColor", className = "" }) {
  return (
    <motion.svg
      width={size}
      height={size}
...
export default function CurrencyTransfer() {
  return (
    ...
    >
      <CardContent className="space-y-4 flex flex-col items-center justify-center" sx={{ padding: 0 }}>
        <motion.div
