...
/**
 * The ServiceTimeSeriesWidget widget.
 */
function ServiceTimeSeriesWidget() {
	...
	if (!stats?.serviceStats?.timeSeries || awaitRender) {
		return null;
	}

	const { timeSeries } = stats.serviceStats;
...
export default memo(ServiceTimeSeriesWidget);
