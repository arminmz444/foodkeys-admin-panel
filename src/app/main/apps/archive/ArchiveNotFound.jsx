...
function ArchiveNotFound({ onRefresh }) {
  const navigate = useNavigate();
  
  return (
    <Box className="w-full p-32 flex flex-col items-center justify-center">
      <ArchiveOutlined className="text-96 text-gray-400" />
      <Typography variant="h5" className="mt-16 mb-8">
        هیچ آرشیوی یافت نشد!
      </Typography>
      <Typography variant="body1" className="mb-16 text-center">
        آرشیوی با مشخصات مورد نظر شما یافت نشد. فیلترها را تغییر دهید یا به صفحه اصلی بازگردید.
      </Typography>
