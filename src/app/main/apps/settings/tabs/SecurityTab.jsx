							...
							render={({ field: { onChange, value } }) => (
								<div className="flex flex-col w-full">
									<FormControlLabel
										...
										label="فعالسازی تایید دو مرحله ای"
										control={
											<Switch
												onChange={(ev) => {
									...
									/>
									<FormHelperText>
										از شما در هر ورود به سامانه، یک رمز یکبار مصرف به صورت پیامکی از طریق پلتفرم خودداری میکند.
									</FormHelperText>
								</div>
							)}
						/>
							...
							render={({ field: { onChange, value } }) => (
								<div className="flex flex-col w-full">
									<FormControlLabel
										...
										labelPlacement="start"
										label="در هر 6 ماه یکبار به شما از تغییر پسورد خودداری میکند"
										control={
											<Switch
												onChange={(ev) => {
													onChange(ev.target.checked);
