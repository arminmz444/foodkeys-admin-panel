...
import UserPanelConfigListCard from "./UserPanelConfigListCard";
...
//     },
//   ];
function UserPanelConfigsPageTab() {
    ...
    <div className="w-full max-w-4xl">
      ...
      <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-32 w-full mt-40">
        {items?.map((item, index) => (
          <UserPanelConfigListCard key={index} {...item} />
        ))}
      </div>
    </div>
  );
...
export default UserPanelConfigsPageTab;
