...
import { useGetAcademyCategoriesQuery, useGetAcademyCoursesQuery } from '../AcademyApi.js';
				...
				>
					<div className="flex flex-col items-center justify-center  mx-auto w-full">
						...
						>
							...
							>
								تنظیمات انتخاب شده در این صفحه، روی وب سایت اصلی مجموعه فودکیز نمایش داده می‌شود
							</Typography>
						</motion.div>
						<motion.div
							initial={{ opacity: 0 }}
