// src/components/ExcelTemplateManager/TemplateManager.jsx (update)
import React, { useEffect, useState } from 'react';
import { useDispatch, useSelector } from 'react-redux';
import { motion, AnimatePresence } from 'framer-motion';
import { Container, Paper, Typography, Box, useMediaQuery, useTheme, Tabs, Tab } from '@mui/material';
...
const TemplateManager = () => {
  ...
  const [activeView, setActiveView] = useState('list'); // 'list', 'upload', 'details', 'process'
    ...
    <Container maxWidth="lg">
      ...
      >
        ...
        <Paper elevation={3} sx={{ mt: 3, overflow: 'hidden' }}>
          {activeView !== 'upload' && activeView !== 'details' && (
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
              ...
              >
                <Tab label="Templates" />
                <Tab label="Generate Excel" />
              </Tabs>
            </Box>
          )}
          
          <Box sx={{ p: isMobile ? 2 : 3, minHeight: '70vh' }}>
