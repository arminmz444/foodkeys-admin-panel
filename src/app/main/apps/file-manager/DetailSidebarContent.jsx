...
import { handleDownload } from "../../../../utils/file-utils"
		...
		>
			...
			<div className="flex flex-col mt-16 border-t border-b divide-y font-medium">
				<div className="flex items-center justify-between py-12">
					<Typography color="text.secondary">ایجاد شده توسط</Typography>
				...
				<div className="flex items-center justify-between py-12">
					<Typography color="text.secondary">آخرین ویرایش در</Typography>
					<Typography>{item.modifiedAt}</Typography>
				</div>
				<div className="flex items-center justify-between py-12">
					<Typography color="text.secondary">حجم</Typography>
			...
			<div className="grid grid-cols-2 gap-16 w-full mt-32">
				<Button
					...
					color="secondary"
					variant="contained"
					onClick={() => handleDownload({ username: '09144226139', fileName: selectedItemId, filePath: path })}
				>
					دانلود
				</Button>
