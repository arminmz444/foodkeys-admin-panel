...
const schema = z.object({
	name: z.string().nonempty('You must enter a company name').min(5, 'The company name must be at least 5 characters')
});
...
function Company() {
	...
	if (
		_.isEmpty(form) ||
		(company && routeParams.companyId !== String(company.id) && routeParams.companyId !== 'new')
	) {
		return <FuseLoading />;
	}
