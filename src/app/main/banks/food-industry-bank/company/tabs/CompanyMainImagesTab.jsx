...
const FLMNGR_SERVER = {
  urlFileManager: "http://127.0.0.1:3001/flmngr",
  urlFiles: "http://127.0.0.1:3001/files/"
};
              ...
              <>
                ...
                <div className="logoButtons">
                  <Button 
                    ...
                    color="primary"
                    onClick={openFlmngr}
                    startIcon={<FuseSvgIcon>{isLoading ? 'heroicons-outline:refresh' : 'heroicons-outline:upload'}</FuseSvgIcon>}
                    disabled={isLoading}
