...
} from '../ServicesBankApi.js';
import { useTheme } from '@mui/material/styles';

/**
 * The product header.
 */
function ServiceSchemaFormHeader() {
	...
	const isValid = true;
	const dirtyFields = true;
	const theme = useTheme()
	const navigate = useNavigate();
	const name = 'companyName';
	const images = 'companyGallery';
	const getValues = () => [];
	const featuredImageId = 'companyGallery';
			...
			<div className="flex flex-col items-start space-y-8 sm:space-y-0 w-full sm:max-w-full min-w-0">
				...
				>
					<Typography
						...
						component={Link}
						role="button"
						to="/banks/food-industry-bank/company"
						color="inherit"
					>
						<FuseSvgIcon size={20}>
							{theme.direction === 'ltr'
...
export default ServiceSchemaFormHeader;
