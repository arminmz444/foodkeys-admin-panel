...
import { useGetECommerceProductQuery } from '../AgricultureIndustryApi';
...
function Company() {
	...
	const {
		...
		isLoading,
		isError
	} = useGetECommerceProductQuery(companyId, {
	 ...
	 */
	if (_.isEmpty(form) || (product && routeParams.companyId !== product.id && routeParams.companyId !== 'new')) {
		return <FuseLoading />;
	}
