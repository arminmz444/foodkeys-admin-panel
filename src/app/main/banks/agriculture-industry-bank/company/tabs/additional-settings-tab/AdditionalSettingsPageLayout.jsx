...
/**
 * More Settings Page Layout
 */
function AdditionalSettingsPageLayout() {
			...
			leftSidebarContent={
				<div className="px-16 py-24">
					<FuseNavigation
						...
						navigation={AdditionalSettingsNavigation.children}
					/>
				</div>
			}
...
export default AdditionalSettingsPageLayout;
