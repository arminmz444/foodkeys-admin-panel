...
import qs from 'qs';
import fa from '@fuse/core/core-i18n/fa';
import en from '@fuse/core/core-i18n/en';
import tr from '@fuse/core/core-i18n/tr';
import ar from '@fuse/core/core-i18n/ar';
/**
 * The defaultTheme object defines the default color palette for the application.
 */
i18next.addResourceBundle('fa', 'core', fa);
i18next.addResourceBundle('en', 'core', en);
i18next.addResourceBundle('tr', 'core', tr);
i18next.addResourceBundle('ar', 'core', ar);
const defaultTheme = {
	palette: {
		mode: 'light',
		text: {
...
export const defaultThemeOptions = {
	direction: 'rtl',
	typography: {
		fontFamily: ['sans', 'yekan', 'Inter var', 'Roboto', '"Helvetica"', 'Arial', 'sans-serif'].join(','),
		fontWeightLight: 300,
